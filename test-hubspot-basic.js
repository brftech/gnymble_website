...
// Test script to verify HubSpot integration with basic properties only
const fs = require('fs');
...
async function testHubSpotIntegration() {
  console.log('🧪 Testing HubSpot Integration with Basic Properties...\n');
  ...
  // Test creating a contact with only basic standard properties
  console.log('👤 Testing contact creation with basic properties...');
  ...
  try {
    ...
    if (createResponse.ok) {
      ...
      console.log('Contact Email:', testContact.properties.email);
  ...
  console.log('\n🎯 Basic HubSpot Integration Test Complete!');
}
